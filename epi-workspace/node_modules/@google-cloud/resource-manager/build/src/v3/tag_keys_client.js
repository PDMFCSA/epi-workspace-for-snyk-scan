...
class TagKeysClient {
    ...
    initialize() {
        ...
        const tagKeysStubMethods = ['listTagKeys', 'getTagKey', 'getNamespacedTagKey', 'createTagKey', 'updateTagKey', 'deleteTagKey', 'getIamPolicy', 'setIamPolicy', 'testIamPermissions'];
