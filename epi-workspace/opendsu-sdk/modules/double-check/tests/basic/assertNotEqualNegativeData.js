...
const f = $$.flow.describe("assertNotEqualNegativeDataTest", {
    action: function (cb) {
        this.cb = cb;
        // this.valueArray1 = [-0, +0, +0, 0, 'foo', false, true, null, undefined];
        // this.valueArray2 = [0, 0, -0, 0, 'foo', false, true, null, undefined];
        this.valueArray1 = [0, undefined, undefined, undefined, -Infinity, {}, function () {
        }, NaN];
        this.valueArray2 = [NaN, 'undefined', null, NaN, Infinity, {}, function () {
        }, NaN];
